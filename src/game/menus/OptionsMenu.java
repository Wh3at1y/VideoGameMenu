...
public class OptionsMenu extends JPanel
	{
		...
		private void buildWindow()
			{
				baseLayout.putConstraint(SpringLayout.WEST, backLabel, 75, SpringLayout.WEST, this);
				baseLayout.putConstraint(SpringLayout.NORTH, toggleClicksLabel, 50, SpringLayout.NORTH, toggleMusicLabel);
				baseLayout.putConstraint(SpringLayout.WEST, toggleClicksLabel, 75, SpringLayout.WEST, this);
				baseLayout.putConstraint(SpringLayout.NORTH, toggleMusicLabel, 150, SpringLayout.NORTH, this);
				baseLayout.putConstraint(SpringLayout.WEST, toggleMusicLabel, 75, SpringLayout.WEST, this);
